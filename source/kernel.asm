...
; Copyright (C) 2014 OS-1 Developers
;
...
; ==================================================================
	...
	%DEFINE OS1_VER '0.3.1'	; OS version number
...
; use a OS-1 system call without having to know its exact position
...
os_main:
	...
	mov es, ax			; segments ever again, as OS-1 and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to OS-1', 0
	os_version_msg		db 'Version ', OS1_VER, 0

	dialog_string_1		db 'Thanks for trying out OS-1!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute OS-1 kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of OS-1, and', 0
