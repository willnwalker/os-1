...
; floppy for KERNEL.BIN (the OS-1 kernel), loads it and executes it.
...
VolumeLabel		db "OS-1       "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; OS-1 kernel filename
